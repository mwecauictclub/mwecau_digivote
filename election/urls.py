...
urlpatterns = [
    ...
    path('tokens/', views.VoterTokenListView.as_view(), name='voter_token_list'), # Optional: add query params for filtering
    ...
    # Placeholder for specific M2M management if needed (example):
    # path('election/<int:election_pk>/level/<str:action>/', views.ElectionLevelManagementView.as_view(), name='election_level_manage'), # action: 'add' or 'remove'
]

# Serve media files in development
if settings.DEBUG: # It's good practice to guard this with DEBUG
